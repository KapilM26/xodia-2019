...
int Board::Level_Counter;
int Board::Level_incrementer;
Board b;
...
X1:// b.display();
	...
	//while(b.MoveValidation(opponent_move))
	{
...
{   
     if(Board::Level_incrementer>7)
     {
	 Board::Level_incrementer=7;
	 }
     Level_Counter=-1;
...
/*	for ( int k=0;validMoves[k]!="fuh";k++)
	{
		cout<<"\n move : "<<validMoves[k]<<"= "<<Move_value[k]<<"\n";
	}
*/	
...
int Board::Mini_Max_1(Board x,string ryan)
{
	...
	if(Level_Counter>(Level_incrementer/2))
	{
		return Move_Weight(ryan);
	}
